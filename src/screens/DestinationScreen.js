import { Image, StyleSheet, Text, View, SafeAreaView, TouchableOpacity, ScrollView } from 'react-native'
...
export default function DestinationScreen(props) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <ScrollView style={styles.descriptionView} contentContainerStyle={{
        gap: 20
      }}>
        ...
        <View style={styles.detailsView}>
            ...
            {/* Distance View */}
            <View style={styles.durationView}>
            <MaterialIcons name="directions-bike" size={24} color="orange" />
                <View style={styles.titleDetails}>
